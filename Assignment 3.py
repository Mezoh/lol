...
def countWords(text_files, stopwords):
    for f in text_files:
...
def main():
    ...
    stop_words_file = [line.strip() for line in open('/Users/famou/Desktop/School/CISC 121/Assignments/Assignment 3/stopwords.txt', 'r', encoding = 'UTF-8')]
    stop_words = set(stop_words_file)
